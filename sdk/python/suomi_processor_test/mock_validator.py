...
from suomi_processor_test.message_types import to_protobuf_class
from suomi_processor_test.message_types import to_message_type
...
class MockValidator(object):
    ...
    async def _send(self, ident, message):
        ...
        :param message (suomi_sdk.protobuf.Message)
