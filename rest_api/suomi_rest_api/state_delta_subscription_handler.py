...
from suomi_rest_api.messaging import ConnectionEvent
...
from suomi_rest_api.protobuf import client_event_pb2
from suomi_rest_api.protobuf import events_pb2
from suomi_rest_api.protobuf import transaction_receipt_pb2
...
class StateDeltaSubscriberHandler:
    ...
    def _make_subscriptions(address_prefixes=None):
        return [
            events_pb2.EventSubscription(event_type="suomi/state-delta"),
            events_pb2.EventSubscription(event_type="suomi/block-commit"),
        ]
...
class StateDeltaEvent:
    def __init__(self, event_list):
        ...
        """
        block_commit = self._get_event("suomi/block-commit", event_list)
        ...
        state_delta = self._get_event("suomi/state-delta", event_list)
