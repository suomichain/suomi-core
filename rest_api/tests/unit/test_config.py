...
from suomi_rest_api.exceptions import RestApiConfigurationError


class TestRestApiConfig(unittest.TestCase):
    def test_rest_api_defaults_suomi_home(self):
    ...
    def test_rest_api_config_load_from_file(self):
        ...
        Sets the SUOMI_HOME environment variable to a temporary directory,
        ...
        try:
            os.environ['SUOMI_HOME'] = directory
