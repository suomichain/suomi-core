...
from suomi_validator.protobuf import state_context_pb2
...
from suomi_validator.execution.context_manager import AuthorizationException
...
class TpStateSetHandler(Handler):
    def __init__(self, context_manager):
        ...
        Args:
            context_manager (suomi_validator.context_manager.
            ContextManager):
        """
        self._context_manager = context_manager
