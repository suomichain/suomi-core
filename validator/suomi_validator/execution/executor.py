...
from suomi_validator.protobuf import processor_pb2
from suomi_validator.protobuf import network_pb2
from suomi_validator.protobuf import transaction_pb2
from suomi_validator.protobuf import validator_pb2
from suomi_validator.protobuf import transaction_receipt_pb2
from suomi_validator.exceptions import WaitCancelledException

from suomi_validator.concurrent.threadpool import \
    InstrumentedThreadPoolExecutor
from suomi_validator.execution.context_manager import \
    CreateContextException
from suomi_validator.execution.scheduler_serial import SerialScheduler
from suomi_validator.execution.scheduler_parallel import ParallelScheduler
from suomi_validator.execution.processor_manager import ProcessorType
from suomi_validator.execution.processor_manager import ProcessorManager
from suomi_validator.execution.processor_manager import \
    RoundRobinProcessorIterator
from suomi_validator.networking.future import FutureResult
from suomi_validator.networking.future import FutureTimeoutError
...
class TransactionExecutorThread(object):
    ...
    def __init__(self,
        ...
        self._tp_settings_key = "suomi.validator.transaction_families"
        self._done = False
    ...
    def _execute_schedule(self):
        for txn_info in self._scheduler:
            ...
            try:
                ...
                LOGGER.error("suomi.validator.transaction_families "
