...
# ------------------------------------------------------------------------------
from suomi_validator.protobuf.transaction_receipt_pb2 import \
    TransactionReceipt
from suomi_validator.protobuf.client_receipt_pb2 import \
...
from suomi_validator.journal.chain import ChainObserver
...
class TransactionReceiptStore(ChainObserver):
    ...
    def __init__(self, receipt_db):
        ...
        Args:
            receipt_db (:obj:suomi_validator.database.database.Database): A
