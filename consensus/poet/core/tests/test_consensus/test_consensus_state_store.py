...
from suomi_poet.poet_consensus import consensus_state
from suomi_poet.poet_consensus import consensus_state_store
...
class TestConsensusStateStore(unittest.TestCase):
    ...
    @mock.patch('suomi_poet.poet_consensus.consensus_state_store.'
                'LMDBNoLockDatabase')
