...
from suomi_poet.poet_consensus.poet_block_verifier import PoetBlockVerifier
...
@mock.patch('suomi_poet.poet_consensus.poet_block_verifier.'
            'ConsensusStateStore')
@mock.patch('suomi_poet.poet_consensus.poet_block_verifier.BlockWrapper')
@mock.patch('suomi_poet.poet_consensus.poet_block_verifier.'
            'PoetSettingsView')
@mock.patch('suomi_poet.poet_consensus.poet_block_verifier.factory')
class TestPoetBlockVerifier(TestCase):
    ...
    @mock.patch(
        'suomi_poet.poet_consensus.poet_block_verifier.ConsensusState')
    @mock.patch('suomi_poet.poet_consensus.poet_block_verifier.'
                'ValidatorRegistryView')
    @mock.patch('suomi_poet.poet_consensus.poet_block_verifier.utils')
