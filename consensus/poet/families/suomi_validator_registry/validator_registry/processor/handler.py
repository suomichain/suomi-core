...
from suomi_sdk.protobuf.setting_pb2 import Setting

from suomi_poet_common import sgx_structs
from suomi_poet_common.protobuf.validator_registry_pb2 import \
    ValidatorInfo
from suomi_poet_common.protobuf.validator_registry_pb2 import \
    ValidatorMap
from suomi_poet_common.protobuf.validator_registry_pb2 import \
...
class ValidatorRegistryTransactionHandler(TransactionHandler):
    ...
    def family_name(self):
        return 'suomi_validator_registry'
    ...
    def _verify_signup_info(self,
        ...
        try:
            report_public_key_pem = \
                _get_config_setting(
                    context=context,
                    key='suomi.poet.report_public_key_pem')
            report_public_key = \
            ...
            raise \
                ValueError(
                    ...
                    '(suomi.poet.report_public_key_pem) not found.')
        ...
        try:
            valid_measurements = \
                _get_config_setting(
                    context=context,
                    key='suomi.poet.valid_enclave_measurements')
            ...
            raise \
                ValueError(
                    ...
                    '(suomi.poet.valid_enclave_measurements) not found.')
        ...
        try:
            valid_basenames = \
                _get_config_setting(
                    context=context,
                    key='suomi.poet.valid_enclave_basenames')
            ...
            raise \
                ValueError(
                    ...
                    '(suomi.poet.valid_enclave_basenames) not found.')
        except ValueError:
            raise \
                ValueError(
