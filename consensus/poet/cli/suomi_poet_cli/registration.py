...
from suomi_poet_cli import config
from suomi_poet_cli.exceptions import CliException
from suomi_poet_cli.poet_enclave_module_wrapper import \
...
from suomi_signing.secp256k1 import Secp256k1PrivateKey

from suomi_validator.journal.block_wrapper import NULL_BLOCK_IDENTIFIER
import suomi_validator.protobuf.transaction_pb2 as txn_pb
import suomi_validator.protobuf.batch_pb2 as batch_pb
...
def do_create(args):
    ...
    input_addresses = \
        output_addresses + \
        [SettingsView.setting_address('suomi.poet.report_public_key_pem'),
         SettingsView.setting_address('suomi.poet.'
                                      'valid_enclave_measurements'),
         SettingsView.setting_address('suomi.poet.valid_enclave_basenames')]
