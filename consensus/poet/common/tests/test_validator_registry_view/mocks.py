...
class MockStateView(object):
    ...
    def get(self, address):
        """See suomi_validator.state.state_view.StateView.get"""
        return self._state[address]

    def addresses(self):
        """See suomi_validator.state.state_view.StateView.addresses"""
        return self._state.keys()

    def leaves(self, prefix):
        """See suomi_validator.state.state_view.StateView.leaves"""
        return {
            address: data
