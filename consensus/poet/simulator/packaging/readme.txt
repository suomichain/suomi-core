...
When using the PoET simulator, the contents of this file must be used to set the value suomi.poet.report_public_key_pem in the configuration settings on the blockchain before the first validator registry transaction is submitted.
