...
from suomi_poet_cli.main import main
...
class TestValidatorRegistryGenesisTransaction(unittest.TestCase):
    ...
    @patch('suomi_poet_cli.registration.PoetKeyStateStore')
    @patch('suomi_poet_cli.registration.config.get_data_dir')
    @patch('suomi_poet_cli.registration.config.get_key_dir')
    ...
    def _assert_validator_transaction(self, public_key, target_file):
        ...
        self.assertEqual('suomi_validator_registry', txn_header.family_name)
