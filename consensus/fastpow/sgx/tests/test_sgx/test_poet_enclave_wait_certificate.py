...
from suomi_poet_sgx.poet_enclave_sgx import poet_enclave as poet

from suomi_validator.config.path import get_default_path_config
...
class TestPoetEnclaveWaitCertificate(TestCase):
    ...
    def setUpClass(cls):
        ...
        with mock.patch(
                'suomi_poet_sgx.poet_enclave_sgx.poet_enclave.open') as _:
            with mock.patch(
                    'suomi_poet_sgx.poet_enclave_sgx.poet_enclave.toml') \
                    as mock_toml:
