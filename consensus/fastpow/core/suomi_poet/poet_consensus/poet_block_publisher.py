...
from suomi_validator.journal.block_wrapper import BlockWrapper
from suomi_validator.journal.consensus.consensus \
    import BlockPublisherInterface
import suomi_validator.protobuf.transaction_pb2 as txn_pb
from suomi_validator.state.settings_view import SettingsView

from suomi_poet.poet_consensus import poet_enclave_factory as factory
from suomi_poet.poet_consensus.consensus_state import ConsensusState
from suomi_poet.poet_consensus.consensus_state_store \
    import ConsensusStateStore
from suomi_poet.poet_consensus.poet_settings_view import PoetSettingsView
from suomi_poet.poet_consensus.signup_info import SignupInfo
from suomi_poet.poet_consensus.poet_key_state_store \
    import PoetKeyState
from suomi_poet.poet_consensus.poet_key_state_store \
    import PoetKeyStateStore
from suomi_poet.poet_consensus.wait_timer import WaitTimer
from suomi_poet.poet_consensus.wait_certificate import WaitCertificate
from suomi_poet.poet_consensus import utils

import suomi_poet_common.protobuf.validator_registry_pb2 as vr_pb

from suomi_poet_common.validator_registry_view.validator_registry_view \
    ...
    def _register_signup_information(self, block_header, poet_enclave_module):
        ...
        input_addresses = \
            ...
            [SettingsView.setting_address(
                'suomi.poet.report_public_key_pem'),
             SettingsView.setting_address(
                 'suomi.poet.valid_enclave_measurements'),
             SettingsView.setting_address(
                 'suomi.poet.valid_enclave_basenames')]

        header = \
            txn_pb.TransactionHeader(
                signer_public_key=block_header.signer_public_key,
                family_name='suomi_validator_registry',
                family_version='1.0',
