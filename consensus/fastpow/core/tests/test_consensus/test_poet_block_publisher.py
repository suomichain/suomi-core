...
from suomi_poet.poet_consensus import poet_block_publisher
from suomi_poet.poet_consensus.mock_consensus_state import\
    MockConsensusState

from suomi_poet_common.protobuf.validator_registry_pb2 \
    import ValidatorInfo
from suomi_poet_common.protobuf.validator_registry_pb2 \
    import SignUpInfo


@mock.patch('suomi_poet.poet_consensus.poet_block_publisher.BlockWrapper')
@mock.patch('suomi_poet.poet_consensus.poet_block_publisher.'
            'PoetSettingsView')
class TestPoetBlockPublisher(TestCase):
    ...
    @mock.patch('suomi_poet.poet_consensus.poet_block_publisher.'
                'ConsensusStateStore')
    @mock.patch('suomi_poet.poet_consensus.poet_block_publisher.factory')
    @mock.patch('suomi_poet.poet_consensus.poet_block_publisher.'
                'ConsensusState')
    @mock.patch('suomi_poet.poet_consensus.poet_block_publisher.'
                'ValidatorRegistryView')
    @mock.patch('suomi_poet.poet_consensus.poet_block_publisher.utils')
    ...
    @mock.patch('suomi_poet.poet_consensus.poet_block_publisher.WaitTimer')
    @mock.patch('suomi_poet.poet_consensus.poet_block_publisher.'
                'SignupInfo')
    @mock.patch('suomi_poet.poet_consensus.poet_block_publisher.'
                'PoetKeyStateStore')
