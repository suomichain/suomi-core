...
from suomi_poet.poet_consensus import poet_fork_resolver
...
# @mock.patch('suomi_poet.poet_consensus.poet_fork_resolver.BlockWrapper')
# @mock.patch('suomi_poet.poet_consensus.poet_fork_resolver.'
#             'PoetSettingsView')
class TestPoetForkResolver(TestCase):
    ...
    @mock.patch('suomi_poet.poet_consensus.poet_fork_resolver.'
                'ConsensusStateStore')
    @mock.patch('suomi_poet.poet_consensus.poet_fork_resolver.factory')
    @mock.patch('suomi_poet.poet_consensus.poet_fork_resolver.'
                'ConsensusState')
    @mock.patch('suomi_poet.poet_consensus.poet_fork_resolver.'
                'ValidatorRegistryView')
    @mock.patch('suomi_poet.poet_consensus.poet_fork_resolver.utils')
    ...
    def test_cur_fork_head_not_poet_block(
        ...
        # check test
        with mock.patch('suomi_poet.poet_consensus.poet_fork_resolver.'
