...
from suomi_sdk.processor.core import TransactionProcessor
...
from suomi_settings.processor.handler import SettingsTransactionHandler
from suomi_settings.processor.config.settings import SettingsConfig
from suomi_settings.processor.config.settings import \
...
DISTRIBUTION_NAME = 'suomi-settings'
...
def create_parser(prog_name):
    parser = argparse.ArgumentParser(
        ...
        epilog='This process is required to apply any changes to on-chain '
               'settings used by the Suomi platform.',
