...
class SettingsMessageFactory(object):
    ...
    def _create_tp_process_request(self, setting, payload):
        inputs = [
            self._key_to_address('suomi.settings.vote.proposals'),
            self._key_to_address('suomi.settings.vote.authorized_keys'),
            self._key_to_address('suomi.settings.vote.approval_threshold'),
