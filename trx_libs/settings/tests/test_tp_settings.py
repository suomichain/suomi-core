...
from suomi_settings.protobuf.settings_pb2 import SettingCandidates
from suomi_settings.protobuf.settings_pb2 import SettingCandidate
from suomi_settings.protobuf.settings_pb2 import SettingVote
from suomi_settings.protobuf.settings_pb2 import SettingProposal

from suomi_settings_test.settings_message_factory \
    import SettingsMessageFactory

from suomi_processor_test.transaction_processor_test_case \
...
class TestSettings(TransactionProcessorTestCase):
    ...
    def test_set_value_bad_approval_threshold(self):
        ...
        """
        self._propose("suomi.settings.vote.approval_threshold", "foo")

        self._expect_get('suomi.settings.vote.authorized_keys',
                         self._public_key)
        self._expect_get('suomi.settings.vote.approval_threshold')
    ...
    def test_set_value_too_large_approval_threshold(self):
        ...
        """
        self._propose("suomi.settings.vote.approval_threshold", "2")
    ...
    def test_set_value_empty_authorized_keys(self):
        ...
        """
        self._propose("suomi.settings.vote.authorized_keys", "")
    ...
    def test_allow_set_authorized_keys_when_initially_empty(self):
        ...
        self._expect_get('suomi.settings.vote.authorized_keys')
        self._expect_set('suomi.settings.vote.authorized_keys',
                         self._public_key)

        self._expect_add_event('suomi.settings.vote.authorized_keys')
    ...
    def test_set_value_proposals(self):
        """
        Tests setting the value of suomi.settings.vote.proposals, which is
        only an internally set structure.
        """
        self._propose('suomi.settings.vote.proposals', EMPTY_CANDIDATES)
    ...
    def test_propose(self):
        ...
        self._expect_get('suomi.settings.vote.authorized_keys',
                         self._public_key)
        self._expect_get('suomi.settings.vote.approval_threshold', '2')
        self._expect_get('suomi.settings.vote.proposals')
        ...
        self._expect_get('suomi.settings.vote.proposals')
        self._expect_set('suomi.settings.vote.proposals',
                         base64.b64encode(candidates.SerializeToString()))

        self._expect_add_event('suomi.settings.vote.proposals')
    ...
    def test_vote_counted(self):
        ...
        self._expect_get('suomi.settings.vote.proposals',
                         base64.b64encode(candidates.SerializeToString()))
        self._expect_get('suomi.settings.vote.approval_threshold', '3')
    ...
    def test_vote_rejected(self):
        ...
        self._expect_get(
            'suomi.settings.vote.authorized_keys',
