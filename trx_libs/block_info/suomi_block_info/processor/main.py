...
from suomi_block_info.processor.handler import BlockInfoTransactionHandler
from suomi_block_info.processor.config.block_info import BlockInfoConfig
from suomi_block_info.processor.config.block_info import \
...
DISTRIBUTION_NAME = 'suomi-block-info'
